...
```{r}
Tabla_hombres <- read_excel("F:/Contingencias_2/Proyecto Final/tablas_probabilidad_transiciones.xlsx", sheet = "Table1_male") %>%
  select(-c(7, 8, 9))
Tabla_mujeres <- read_excel("F:/Contingencias_2/Proyecto Final/tablas_probabilidad_transiciones.xlsx", sheet = "Table2_female")
...
Resultados_Agregados_financieros <- lapply(seq_len(n_annos), function(anno) {
  ...
  data.frame(
    ...
    mujeres_egresos_muerto_mean = mean(sim_data$hmujeres_egresos_muerto))
})
