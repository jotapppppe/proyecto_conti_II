...
for (sim in 1:n_simulaciones) {
  ...
  for (anno in 1:horizonte) {
    ...
    Financiero <- data.frame(  hombres_ingresos_sano = Prima*Personas[1,1] ,
                                      ...
                                      hombres_egresos_muerto = 30400000 * nrow(poblacion[(poblacion$Sexo == 0) & (poblacion$Estado == 3) & (poblacion$Estado_anterior == 0), ]) + 20400000 * nrow(poblacion[(poblacion$Sexo == 0) & (poblacion$Estado == 3) & (poblacion$Estado_anterior == 1), ]) + 10400000 * nrow(poblacion[(poblacion$Sexo == 0) & (poblacion$Estado == 3) & (poblacion$Estado_anterior == 2), ]),
                                      ...
                                      mujeres_egresos_muerto = 30400000 * nrow(poblacion[(poblacion$Sexo == 1) & (poblacion$Estado == 3) & (poblacion$Estado_anterior == 0), ]) + 20400000 * nrow(poblacion[(poblacion$Sexo == 1) & (poblacion$Estado == 3) & (poblacion$Estado_anterior == 1), ]) + 10400000 * nrow(poblacion[(poblacion$Sexo == 1) & (poblacion$Estado == 3) & (poblacion$Estado_anterior == 2), ]))
